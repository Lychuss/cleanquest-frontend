    ...
    return <>
        ...
        <div className="relative ">
            <Image
                ...
                width={500}
                height={500}
                className="relative z-50 top-[15px] left-3 w-[108px] h-[100px]"
                loading="eager"
            />
            <div className="absolute rounded-lg left-5 top-5 bg-black/50 w-[90px] h-[90px] p-2">
                    <h1 className="text-[rgba(210,157,6,0.8)] text-[6px] mb-1">PLAYER STATS</h1>
                    <div>
                        <ul>
                            {arrayOfTask.map((power, i) => (
                                <li className="text-[5px]" key={i}>
                                    <p className="grid grid-cols-[1fr_50px_40px] items-center">
