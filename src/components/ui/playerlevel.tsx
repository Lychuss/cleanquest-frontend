...
export default function PlayerLevel(props: MyProps){
    return <div className="flex p-1 items-center border-transparent rounded-lg  bg-[rgba(20,16,18,0.8)]/30">
                <Image src="/icons/level-v1.png" alt="level-icon" width={1000} height={1000} className="w-[50px] h-auto"/> 
                <div>
                    <h1 className="text-[9px] font-semibold text-white">{props.ign}</h1>
                    <h1 className="text-[7px] font-semibold text-[rgba(210,157,6,0.8)] mb-1">Level <span className="text-white">{props.level}</span></h1>
                    ...
                    <h1 className="mt-1 text-[7px] text-[rgba(154,154,154,0.8)]">{props.exp}/100</h1>
                </div>
            </div>
}